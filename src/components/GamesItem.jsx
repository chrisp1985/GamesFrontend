...
const GamesItem = ({ item, onRemoveItem }) => (
  <li className="flex items-center text-base text-body-color dark:text-dark-6 gap-3">
  ...
  <span className="text-primary p-1 italic">{item.console}</span>
  <span className="text-primary p-1">{item.rating}</span>
